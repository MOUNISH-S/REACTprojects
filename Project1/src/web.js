        ...
        <div className='bod'>
            ...
            <div className="top">
                <div style={{ paddingRight: '10px', float: 'right' }}>
                    <Link to="/log"><button id="login" type="button" style={{ marginTop: '7px', height: '55px', width: '100px', borderRadius: '40px', border: '1px solid white', fontSize: '15px', fontWeight: 'bold', cursor: 'pointer' }}>Log in</button></Link>
                </div>
