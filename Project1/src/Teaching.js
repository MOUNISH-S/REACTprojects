    ...
    return (
        ...
        <div className = "entire-page">
            ...
            <div id="Flex-container">
                ...
                <div id="FLEX-CHILD1">
                    <div style={{ width: "1fr", height: "200px" }}> <img class="image4" src="" alt="" /></div>
                    ...
                    <div style={{ width: "1fr", height: "200px" }}> <img class="image3" src="" alt="" /></div>
            </div>
                ...
                <div id="FLEX-CHILD2" style={{ marginLeft: "3vw" }}>
                   ...
                   <div style={{textAlign:'center'}}><Link to="/submit#FollowUs"> <Button variant="contained">SUBMIT</Button> </Link></div>
                </div>
                    </div>
                </div>
              </div>
